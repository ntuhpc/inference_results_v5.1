...
dataset_info_map = {
    ...
    "llama3-openorca": {
        "model_name": "/models/models/Llama-3.1-405B-Instruct-quark-fp8",
        "dataset_path": "/models/llama3.1-405B-dataset/mlperf_llama3.1_405b_dataset_8313_processed_fp16_eval.pkl",
        "total_sample_count": 8313,
    },
    "mixtral-dataset": {
