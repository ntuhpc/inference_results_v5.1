...
base = {
    ...
    llm_fields.trtllm_runtime_flags: {
        ...
        'kvcache_free_gpu_mem_frac': 0.99, #0.9,  # Progressively lower by 0.1/0.05 if you hit OOM errors.
    ...
    loadgen_fields.offline_expected_qps: 1150, #1100-valid, #440, #435, #440-best,
