See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/HPE/results/HPE_PROLIANT_DL380A_RTX_PRO_6000_PCIE_96GBx8_TRT_TRT/summary.html)
<header class="topbar">
...
<h2>HPE - HPE ProLiant Compute DL380a Gen12 (8x RTX Pro 6000 Blackwell Server Edition)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/results/HPE_PROLIANT_DL380A_RTX_PRO_6000_PCIE_96GBx8_TRT_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/measurements/HPE_PROLIANT_DL380A_RTX_PRO_6000_PCIE_96GBx8_TRT_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/compliance/HPE_PROLIANT_DL380A_RTX_PRO_6000_PCIE_96GBx8_TRT_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<table class="table">
<tr><td>accelerator_model_name</td><td>NVIDIA RTX PRO 6000 Blackwell Server Edition</td></tr><tr><td>accelerators_per_node</td><td>8</td></tr><tr><td>accelerator_memory_capacity</td><td>96Gi</td></tr><tr><td>accelerator_host_interconnect</td><td>PCIe Gen5 Switch</td></tr><tr><td>accelerator_frequency</td><td>1,065MHz</td></tr><tr><td>accelerator_interconnect</td><td>PCIe Gen5 Switch</td></tr><tr><td>accelerator_interconnect_topology</td><td></td></tr><tr><td>accelerator_memory_configuration</td><td>HBM2e</td></tr><tr><td>accelerator_on-chip_memories</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Xeon(R) 6787P</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>172</td></tr><tr><td>host_processor_frequency</td><td>2.4GHz</td></tr><tr><td>host_memory_capacity</td><td>2048GB</td></tr><tr><td>host_memory_configuration</td><td>16x 64GB 36ASF8G72PZ-3G2E1</td></tr><tr><td>host_processor_caches</td><td>L1d: 8.1MiB MiB, L1i: 10.8 MiB, L2: 344 MiB, L3: 672 MiB</td></tr><tr><td>host_processor_interconnect</td><td>UPI</td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td>1.18</td></tr><tr><td>framework</td><td>TensorRT 10.11.0.33, CUDA 12.9</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04.2</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.11.0.33, CUDA 12.9, Driver 575.57.08</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">26005.90</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">26205.80</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">26001.00</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">26205.30</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">46060.00</td><td class="units">Queries/s</td> <td class="perf">36052.30</td><td class="units">Tokens/s</td> <td class="perf">46841.80</td><tr><td class="model">mixtral-8x7b</td><td class="acc-target">ROUGE1: 45.1429, ROUGE2: 23.1191, ROUGEL: 30.1562, TOKENS_PER_SAMPLE: 130.356, gsm8k_accuracy: 72.9234, mbxp_accuracy: 59.5584</td><td class="units">Tokens/s</td> <td class="perf">30134.30</td><td class="na" colspan="2"> N/A </td><td class="units">Tokens/s</td> <td class="perf">32738.80</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Queries/s</td> <td class="perf">10.88</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">11.08</td></table></div></div>
</div>
</div>
</main>
