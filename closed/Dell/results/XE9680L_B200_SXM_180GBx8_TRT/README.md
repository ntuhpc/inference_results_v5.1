See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Dell/results/XE9680L_B200_SXM_180GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>Dell - Dell PowerEdge XE9680L (8x B200-SXM-180GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/results/XE9680L_B200_SXM_180GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/measurements/XE9680L_B200_SXM_180GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/compliance/XE9680L_B200_SXM_180GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>INTEL(R) XEON(R) PLATINUM 8562Y+</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>64</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>4 TB</td></tr><tr><td>host_memory_configuration</td><td>32x 128GB DDR5 </td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">deepseek-r1</td><td class="acc-target">exact_match: 80.5446, TOKENS_PER_SAMPLE: 3497.6047</td><td class="units">Tokens/s</td> <td class="perf">13913.30</td><td class="na" colspan="2"> N/A </td><td class="units">Tokens/s</td> <td class="perf">30493.30</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">99139.20</td><td class="units">Tokens/s</td> <td class="perf">60137.60</td><td class="units">Tokens/s</td> <td class="perf">101253.00</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">99139.20</td><td class="units">Tokens/s</td> <td class="perf">60137.60</td><td class="units">Tokens/s</td> <td class="perf">101253.00</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">1243.17</td><td class="units">Tokens/s</td> <td class="perf">751.37</td><td class="units">Tokens/s</td> <td class="perf">1648.03</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">128787.00</td><td class="units">Queries/s</td> <td class="perf">102907.00</td><td class="units">Tokens/s</td> <td class="perf">143309.00</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">45024.20</td></table></div></div>
</div>
</div>
</main>
