See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Dell_Broadcom/results/vXE9680_H200-SXM-141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>Dell_Broadcom - Dell PowerEdge XE9680 (8x H200-SXM-141GB,VMware ESXi 9.0.0)</h2>
</div>
...
<span id="tester_val" class="details-cell">Dell_Broadcom</span>
</div>
<div class="details-group">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell_Broadcom/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell_Broadcom/results/vXE9680_H200-SXM-141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell_Broadcom/measurements/vXE9680_H200-SXM-141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell_Broadcom/compliance/vXE9680_H200-SXM-141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<table class="table">
<tr><td>accelerator_model_name</td><td>Virtualized NVIDIA H200-SXM-141GB</td></tr><tr><td>accelerators_per_node</td><td>8</td></tr><tr><td>accelerator_memory_capacity</td><td>141 GB</td></tr><tr><td>accelerator_host_interconnect</td><td>PCIe Gen5 x16</td></tr><tr><td>accelerator_frequency</td><td></td></tr><tr><td>accelerator_interconnect</td><td>TBD</td></tr><tr><td>accelerator_interconnect_topology</td><td></td></tr><tr><td>accelerator_memory_configuration</td><td>HBM3e</td></tr><tr><td>accelerator_on-chip_memories</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Xeon(R) Platinum 8568Y</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>48</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>3 TB</td></tr><tr><td>host_memory_configuration</td><td>32x 96GB DDR5 DIMM 4400 MT/s</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.11, CUDA 12.8</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04, VMware ESXi 9.0.0 24755229</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.11, CUDA 12.8, cuDNN 9.11.2, Driver 570.158.01</td></tr><tr><td>sw_notes</td><td>VM Specifications 48vCPU out of 96 and memory of 2TB GB out of 2TB</td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33384.70</td><td class="units">Tokens/s</td> <td class="perf">34301.90</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33370.60</td><td class="units">Tokens/s</td> <td class="perf">34485.70</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">277.33</td><td class="units">Tokens/s</td> <td class="perf">547.26</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Queries/s</td> <td class="perf">17.95</td><td class="units">Samples/s</td> <td class="perf">18.64</td></table></div></div>
</div>
</div>
</main>
