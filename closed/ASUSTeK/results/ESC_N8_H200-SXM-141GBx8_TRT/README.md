See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/ASUSTeK/results/ESC_N8_H200-SXM-141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>ASUSTeK - ASUSTeK ESC N8 H200 (8x H200-SXM-141GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/results/ESC_N8_H200-SXM-141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/measurements/ESC_N8_H200-SXM-141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/compliance/ESC_N8_H200-SXM-141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>INTEL(R) XEON(R) PLATINUM 8580</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>60</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>2 TB</td></tr><tr><td>host_memory_configuration</td><td>32x 64GB</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">dlrm-v2-99</td><td class="acc-target">AUC: 79.5069</td><td class="units">Queries/s</td> <td class="perf">591162.00</td><td class="units">Samples/s</td> <td class="perf">643122.00</td><tr><td class="model">dlrm-v2-99.9</td><td class="acc-target">AUC: 80.2297</td><td class="units">Queries/s</td> <td class="perf">370066.00</td><td class="units">Samples/s</td> <td class="perf">388058.00</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">34193.80</td><td class="units">Tokens/s</td> <td class="perf">35075.10</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">29026.90</td><td class="units">Tokens/s</td> <td class="perf">34887.20</td><tr><td class="model">mixtral-8x7b</td><td class="acc-target">ROUGE1: 45.1429, ROUGE2: 23.1191, ROUGEL: 30.1562, TOKENS_PER_SAMPLE: 130.356, gsm8k_accuracy: 72.9234, mbxp_accuracy: 59.5584</td><td class="units">Tokens/s</td> <td class="perf">59992.80</td><td class="units">Tokens/s</td> <td class="perf">61372.40</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">14406.00</td><td class="units">Samples/s</td> <td class="perf">14451.70</td></table></div></div>
</div>
</div>
</main>
