...
base = {
    ...
    llm_fields.trtllm_runtime_flags: {
        ...
        'max_num_tokens': 12000, #1536, #12000,
        'batch_scheduler_policy': 'max_util',
        'context_chunking_policy': 'first_come_first_served',
        'kvcache_free_gpu_mem_frac': 0.99, #0.97, #0.9,  # Progressively lower by 0.1/0.05 if you hit OOM errors.
        'enable_chunked_context': True,
        'cuda_graph_padding_enabled': True,
        'workers_per_core': 2, #12,
        'max_concurrency': -1,
    },
    ...
    model_fields.gpu_batch_size: {
        'llama3_1-8b': 2048, #6000-B200 default,
    },
    loadgen_fields.server_target_qps: 505, #510-invalid, #500, #480, #460-59k, #1100, #900, #850, #460.0, #450.0, #850-B200 default,
