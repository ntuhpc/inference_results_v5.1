...
base = {
    ...
    llm_fields.warmup_iterations: 1,
    ...
    llm_fields.trtllm_runtime_flags: {
        ...
        'kvcache_free_gpu_mem_frac': 0.6,  # Progressively lower by 0.1/0.05 if you hit OOM errors.
    ...
    loadgen_fields.offline_expected_qps: 10,
