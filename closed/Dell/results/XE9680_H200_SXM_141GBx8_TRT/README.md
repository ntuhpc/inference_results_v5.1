See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Dell/results/XE9680_H200_SXM_141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>DELL - Dell PowerEdge XE9680 (8xH200-SXM-141GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/results/XE9680_H200_SXM_141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/measurements/XE9680_H200_SXM_141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Dell/compliance/XE9680_H200_SXM_141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.11, CUDA 12.8</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.11, CUDA 12.8, cuDNN 9.10, Driver 570.133</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33244.30</td><td class="units">Tokens/s</td> <td class="perf">21915.60</td><td class="units">Tokens/s</td> <td class="perf">35316.70</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33244.30</td><td class="units">Tokens/s</td> <td class="perf">21915.60</td><td class="units">Tokens/s</td> <td class="perf">35316.70</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">13603.30</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">14960.70</td></table></div></div>
</div>
</div>
</main>
