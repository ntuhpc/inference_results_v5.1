See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Quanta_Cloud_Technology/results/D74U-7U_H200-SXM-141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>Quanta_Cloud_Technology - QuantaGrid D74H-7U (8x H200-SXM-141GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/results/D74U-7U_H200-SXM-141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/measurements/D74U-7U_H200-SXM-141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/compliance/D74U-7U_H200-SXM-141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">dlrm-v2-99</td><td class="acc-target">AUC: 79.5069</td><td class="units">Queries/s</td> <td class="perf">585168.00</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">647861.00</td><tr><td class="model">dlrm-v2-99.9</td><td class="acc-target">AUC: 80.2297</td><td class="units">Queries/s</td> <td class="perf">370068.00</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">389330.00</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33356.20</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">35091.50</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33352.60</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">34876.40</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">295.52</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">550.11</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">57970.40</td><td class="units">Queries/s</td> <td class="perf">54117.60</td><td class="units">Tokens/s</td> <td class="perf">56917.30</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">13603.30</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">14539.50</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Queries/s</td> <td class="perf">18.42</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">19.19</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">33363.80</td></table></div></div>
</div>
</div>
</main>
