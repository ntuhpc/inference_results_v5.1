See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/open/GATEOverflow/results/GATEOverflow_AMD_AM5-ctuning_cpp_tflite-cpu-tflite_vmaster-default_config/summary.html)
<header class="topbar">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/GATEOverflow/results/GATEOverflow_AMD_AM5-ctuning_cpp_tflite-cpu-tflite_vmaster-default_config" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/GATEOverflow/measurements/GATEOverflow_AMD_AM5-ctuning_cpp_tflite-cpu-tflite_vmaster-default_config" class="button">Measurements</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>AMD Ryzen 9 7950X 16-Core Processor</td></tr><tr><td>host_processors_per_node</td><td>1</td></tr><tr><td>host_processor_core_count</td><td>16</td></tr><tr><td>host_processor_frequency</td><td>5883.0000</td></tr><tr><td>host_memory_capacity</td><td>131G</td></tr><tr><td>host_memory_configuration</td><td>undefined</td></tr><tr><td>host_processor_caches</td><td>L1d cache: 512 KiB (16 instances), L1i cache: 512 KiB (16 instances), L2 cache: 16 MiB (16 instances), L3 cache: 64 MiB (2 instances)</td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>framework</td><td>tflite vmaster</td></tr><tr><td>operating_system</td><td>Ubuntu 25.04 (linux-6.14.0-24-generic-glibc2.41)</td></tr><tr><td>other_software_stack</td><td>Python: 3.13.3, AOCC-5.0.0-Build#1377</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">mobilenet-v1-precision_uint8-0.25-128</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 42.31</td><td class="units">Samples/s</td> <td class="perf">3393.68</td><td class="accuracy">acc: 42.31</td><td class="units">Latency (ms)</td> <td class="perf">0.30</td><td class="accuracy">acc: 42.31</td><td class="units">Latency (ms)</td> <td class="perf">2.40</td><tr><td class="model">mobilenet-v1-precision_uint8-0.25-160</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 45.506</td><td class="units">Samples/s</td> <td class="perf">2255.18</td><td class="accuracy">acc: 45.506</td><td class="units">Latency (ms)</td> <td class="perf">0.45</td><td class="accuracy">acc: 45.506</td><td class="units">Latency (ms)</td> <td class="perf">3.61</td><tr><td class="model">mobilenet-v1-precision_uint8-0.25-192</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 48.074</td><td class="units">Samples/s</td> <td class="perf">1580.07</td><td class="accuracy">acc: 48.074</td><td class="units">Latency (ms)</td> <td class="perf">0.64</td><td class="accuracy">acc: 48.074</td><td class="units">Latency (ms)</td> <td class="perf">5.14</td><tr><td class="model">mobilenet-v1-precision_uint8-0.25-224</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 50.224</td><td class="units">Samples/s</td> <td class="perf">1185.82</td><td class="accuracy">acc: 50.224</td><td class="units">Latency (ms)</td> <td class="perf">0.85</td><td class="accuracy">acc: 50.224</td><td class="units">Latency (ms)</td> <td class="perf">6.82</td><tr><td class="model">mobilenet-v1-precision_uint8-0.5-128</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 56.674</td><td class="units">Samples/s</td> <td class="perf">1407.40</td><td class="accuracy">acc: 56.674</td><td class="units">Latency (ms)</td> <td class="perf">0.71</td><td class="accuracy">acc: 56.674</td><td class="units">Latency (ms)</td> <td class="perf">5.76</td><tr><td class="model">mobilenet-v1-precision_uint8-0.5-160</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 59.48</td><td class="units">Samples/s</td> <td class="perf">933.71</td><td class="accuracy">acc: 59.48</td><td class="units">Latency (ms)</td> <td class="perf">1.07</td><td class="accuracy">acc: 59.48</td><td class="units">Latency (ms)</td> <td class="perf">8.65</td><tr><td class="model">mobilenet-v1-precision_uint8-0.5-192</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 61.484</td><td class="units">Samples/s</td> <td class="perf">656.29</td><td class="accuracy">acc: 61.484</td><td class="units">Latency (ms)</td> <td class="perf">1.53</td><td class="accuracy">acc: 61.484</td><td class="units">Latency (ms)</td> <td class="perf">12.29</td><tr><td class="model">mobilenet-v1-precision_uint8-0.5-224</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 62.308</td><td class="units">Samples/s</td> <td class="perf">494.00</td><td class="accuracy">acc: 62.308</td><td class="units">Latency (ms)</td> <td class="perf">2.03</td><td class="accuracy">acc: 62.308</td><td class="units">Latency (ms)</td> <td class="perf">16.32</td><tr><td class="model">mobilenet-v1-precision_uint8-0.75-128</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 58.398</td><td class="units">Samples/s</td> <td class="perf">697.03</td><td class="accuracy">acc: 58.398</td><td class="units">Latency (ms)</td> <td class="perf">1.44</td><td class="accuracy">acc: 58.398</td><td class="units">Latency (ms)</td> <td class="perf">11.59</td><tr><td class="model">mobilenet-v1-precision_uint8-0.75-160</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 64.126</td><td class="units">Samples/s</td> <td class="perf">464.11</td><td class="accuracy">acc: 64.126</td><td class="units">Latency (ms)</td> <td class="perf">2.16</td><td class="accuracy">acc: 64.126</td><td class="units">Latency (ms)</td> <td class="perf">17.40</td><tr><td class="model">mobilenet-v1-precision_uint8-0.75-192</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 67.198</td><td class="units">Samples/s</td> <td class="perf">325.30</td><td class="accuracy">acc: 67.198</td><td class="units">Latency (ms)</td> <td class="perf">3.09</td><td class="accuracy">acc: 67.198</td><td class="units">Latency (ms)</td> <td class="perf">24.77</td><tr><td class="model">mobilenet-v1-precision_uint8-0.75-224</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 68.138</td><td class="units">Samples/s</td> <td class="perf">245.36</td><td class="accuracy">acc: 68.138</td><td class="units">Latency (ms)</td> <td class="perf">4.09</td><td class="accuracy">acc: 68.138</td><td class="units">Latency (ms)</td> <td class="perf">32.85</td><tr><td class="model">mobilenet-v1-precision_uint8-1.0-128</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 64.794</td><td class="units">Samples/s</td> <td class="perf">435.19</td><td class="accuracy">acc: 64.794</td><td class="units">Latency (ms)</td> <td class="perf">2.31</td><td class="accuracy">acc: 64.794</td><td class="units">Latency (ms)</td> <td class="perf">18.53</td><tr><td class="model">mobilenet-v1-precision_uint8-1.0-160</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 68.272</td><td class="units">Samples/s</td> <td class="perf">290.35</td><td class="accuracy">acc: 68.272</td><td class="units">Latency (ms)</td> <td class="perf">3.46</td><td class="accuracy">acc: 68.272</td><td class="units">Latency (ms)</td> <td class="perf">27.78</td><tr><td class="model">mobilenet-v1-precision_uint8-1.0-192</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 70.022</td><td class="units">Samples/s</td> <td class="perf">203.50</td><td class="accuracy">acc: 70.022</td><td class="units">Latency (ms)</td> <td class="perf">4.93</td><td class="accuracy">acc: 70.022</td><td class="units">Latency (ms)</td> <td class="perf">39.65</td><tr><td class="model">mobilenet-v1-precision_uint8-1.0-224</td><td class="acc-target">acc: 75.6954</td><td class="accuracy">acc: 70.772</td><td class="units">Samples/s</td> <td class="perf">153.83</td><td class="accuracy">acc: 70.772</td><td class="units">Latency (ms)</td> <td class="perf">6.52</td><td class="accuracy">acc: 70.772</td><td class="units">Latency (ms)</td> <td class="perf">52.37</td></table></div></div>
</div>
</div>
</main>
