...
class H100_SXM_80GB_TP2x2(H100_SXM_80GB_TP2x1):
    ...
    offline_expected_qps = H100_SXM_80GB_TP2x1.offline_expected_qps * 2


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP, "PP2")
class H100_SXM_80GB_TP2x4(H100_SXM_80GB_TP2x2):
    system = KnownSystem.H100_SXM_80GBx8
    offline_expected_qps = H100_SXM_80GB_TP2x2.offline_expected_qps * 2


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxQ, "PP2")
class H100_SXM_80GB_MaxQ_PP2x4(H100_SXM_80GB_TP2x4):
    system = KnownSystem.H100_SXM_80GBx8
...
class H100_SXM_80GB_HighAccuracy_PP2x1(H100_SXM_80GB_TP2x1):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP, "PP2")
class H100_SXM_80GB_HighAccuracy_PP2x4(H100_SXM_80GB_TP2x4):
    pass
