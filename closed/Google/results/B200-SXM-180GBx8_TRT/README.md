See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Google/results/B200-SXM-180GBx8_TRT/summary.html)
<header class="topbar">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Google/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Google/results/B200-SXM-180GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Google/measurements/B200-SXM-180GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Google/compliance/B200-SXM-180GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">deepseek-r1</td><td class="acc-target">exact_match: 80.5446, TOKENS_PER_SAMPLE: 3497.6047</td><td class="units">Tokens/s</td> <td class="perf">14630.70</td><td class="na" colspan="2"> N/A </td><td class="units">Tokens/s</td> <td class="perf">31920.30</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">99169.80</td><td class="units">Tokens/s</td> <td class="perf">52140.70</td><td class="units">Tokens/s</td> <td class="perf">78463.50</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">99169.80</td><td class="units">Tokens/s</td> <td class="perf">52140.70</td><td class="units">Tokens/s</td> <td class="perf">78463.50</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">1246.79</td><td class="units">Tokens/s</td> <td class="perf">750.45</td><td class="units">Tokens/s</td> <td class="perf">1655.36</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">119628.00</td><td></td><td></td><td class="units">Tokens/s</td> <td class="perf">141138.00</td><tr><td class="model">rgat</td><td class="acc-target">acc: 0.7213</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">630364.00</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Queries/s</td> <td class="perf">28.46</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">32.12</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">42755.70</td></table></div></div>
</div>
</div>
</main>
