...
DATASET_FILE_PATH=/models/amd2025_model/data/processed-openorca/open_orca_gpt4_tokenized_llama.sampled_24576.pkl
MODEL_PATH=/models/amd2025_model/model/llama2-70b-chat-hf/quantized
