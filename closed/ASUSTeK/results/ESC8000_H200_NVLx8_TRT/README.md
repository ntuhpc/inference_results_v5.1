See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/ASUSTeK/results/ESC8000_H200_NVLx8_TRT/summary.html)
<header class="topbar">
...
<h2>ASUSTeK - ESC8000A-E12 (8x H200-NVL-141GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/results/ESC8000_H200_NVLx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/measurements/ESC8000_H200_NVLx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/ASUSTeK/compliance/ESC8000_H200_NVLx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.8, CUDA 12.9</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.8, CUDA 12.9, cuDNN 8.9.7, Driver 560.30</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">dlrm-v2-99</td><td class="acc-target">AUC: 79.5069</td><td class="units">Queries/s</td> <td class="perf">450100.00</td><td class="units">Samples/s</td> <td class="perf">580460.00</td><tr><td class="model">dlrm-v2-99.9</td><td class="acc-target">AUC: 80.2297</td><td class="units">Queries/s</td> <td class="perf">330555.00</td><td class="units">Samples/s</td> <td class="perf">348225.00</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">25614.70</td><td class="units">Tokens/s</td> <td class="perf">30487.00</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">24554.70</td><td class="units">Tokens/s</td> <td class="perf">30490.80</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">12801.90</td><td class="units">Samples/s</td> <td class="perf">13319.50</td></table></div></div>
</div>
</div>
</main>
