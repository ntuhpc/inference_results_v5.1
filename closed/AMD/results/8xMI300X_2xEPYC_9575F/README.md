See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/AMD/results/8xMI300X_2xEPYC_9575F/summary.html)
<header class="topbar">
...
<h2>AMD - Supermicro AS-8125GS-TNMR2</h2>
</div>
...
<span id="tester_val" class="details-cell">AMD</span>
</div>
<div class="details-group">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/AMD/results/8xMI300X_2xEPYC_9575F" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/AMD/measurements/8xMI300X_2xEPYC_9575F" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/AMD/compliance/8xMI300X_2xEPYC_9575F" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>AMD EPYC 9575F</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>64</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>1.5TiB</td></tr><tr><td>host_memory_configuration</td><td>24x 64GB Micron Technology MTC40F2046S1RC64BD2 MWFF</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>vLLM 0.9.0.2.dev108+g71faa1880.d20250730.rocm641, Pytorch 2.7.0+gitf717b2a, ROCm 6.4.1.60401-83~22.04</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04 LTS</td></tr><tr><td>other_software_stack</td><td>hipblaslt 0.15.0-aa0bda7b, flash-attn 2.7.2</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">24593.80</td><td class="units">Tokens/s</td> <td class="perf">8840.42</td><td class="units">Tokens/s</td> <td class="perf">27803.90</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">24593.80</td><td class="units">Tokens/s</td> <td class="perf">8840.42</td><td class="units">Tokens/s</td> <td class="perf">27803.90</td><tr><td class="model">mixtral-8x7b</td><td class="acc-target">ROUGE1: 45.1429, ROUGE2: 23.1191, ROUGEL: 30.1562, TOKENS_PER_SAMPLE: 130.356, gsm8k_accuracy: 72.9234, mbxp_accuracy: 59.5584</td><td class="units">Tokens/s</td> <td class="perf">47804.30</td><td class="na" colspan="2"> N/A </td><td class="units">Tokens/s</td> <td class="perf">53017.30</td></table></div></div>
</div>
</div>
</main>
