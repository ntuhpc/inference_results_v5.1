...
Platform: GATEOverflow_Intel_SPR_i9-reference-gpu-vllm-default_config

Model Precision: fp32

### Accuracy Results 
`ACCURACY`: `97.95578`, Required accuracy for closed division `>= 96.95357`

### Performance Results 
`Samples per second`: `135.977`
