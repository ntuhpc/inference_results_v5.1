...
models_hf = (
    ...
    ("meta-llama/Llama-3.1-405B-Instruct", "llama3.1-405b/orig"),
    # Premade models (requires token)
    # ("amd/Llama-2-70b-chat-hf_FP8_MLPerf_V2", "llama2-70b-chat-hf/fp8_quantized"),
    # ("amd/Meta-Llama-3.1-405B-Instruct_FP8_MLPerf_V4", "llama3.1-405b/fp8_quantized"),
    # ("amd/Meta-Llama-3.1-405B-Instruct-wmxfp4-amxfp4-kvfp8-scale-uint8-asq-mlperf", "llama3.1-405b/fp4_quantized"),
)
