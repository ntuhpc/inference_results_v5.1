See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Nebius/results/H200-SXM-141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>Nebius - Nebius H200 (8x H200-SXM-141GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Nebius/results/H200-SXM-141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Nebius/measurements/H200-SXM-141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Nebius/compliance/H200-SXM-141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Xeon(R) Platinum 8468</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>48</td></tr><tr><td>host_processor_frequency</td><td>2.1 GHz (base); 3.8 GHz (max turbo)</td></tr><tr><td>host_memory_capacity</td><td>1.6 TB</td></tr><tr><td>host_memory_configuration</td><td>32x 64GB MTC40F2046S1RC48BA1</td></tr><tr><td>host_processor_caches</td><td>L1d: 4.5 MiB (96 instances); L1i: 3 MiB (96 instances); L2: 192 MiB (96 instances); L3: 210 MiB (2 instances)</td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.11, CUDA 12.9</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 22.04.5 LTS (Linux kernel: 5.15.0-144-generic #157-Ubuntu SMP Mon Jun 16 07:33:10 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux)</td></tr><tr><td>other_software_stack</td><td>CUDA 12.9, Driver 575.57.08, cuDNN 9.10</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">34029.40</td><td class="units">Tokens/s</td> <td class="perf">23079.90</td><td class="units">Tokens/s</td> <td class="perf">34812.10</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">34029.40</td><td class="units">Tokens/s</td> <td class="perf">23079.90</td><td class="units">Tokens/s</td> <td class="perf">34812.10</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">295.36</td><td class="units">Tokens/s</td> <td class="perf">202.78</td><td class="units">Tokens/s</td> <td class="perf">552.75</td></table></div></div>
</div>
</div>
</main>
