See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/HPE/results/HPE_Cray_XD670_H200_SXM_141GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>HPE - HPE Cray XD670 (8x H200-SXM-141GB)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/results/HPE_Cray_XD670_H200_SXM_141GBx8_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/measurements/HPE_Cray_XD670_H200_SXM_141GBx8_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/HPE/compliance/HPE_Cray_XD670_H200_SXM_141GBx8_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.11, CUDA 12.9</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>RHEL 9.4</td></tr><tr><td>other_software_stack</td><td>Driver 570.86.15</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33164.40</td><td class="units">Tokens/s</td> <td class="perf">20432.10</td><td class="units">Tokens/s</td> <td class="perf">34964.60</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">33144.10</td><td class="units">Tokens/s</td> <td class="perf">20356.80</td><td class="units">Tokens/s</td> <td class="perf">34797.00</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">64914.60</td><td class="units">Queries/s</td> <td class="perf">53475.20</td><td class="units">Tokens/s</td> <td class="perf">66036.80</td><tr><td class="model">mixtral-8x7b</td><td class="acc-target">ROUGE1: 45.1429, ROUGE2: 23.1191, ROUGEL: 30.1562, TOKENS_PER_SAMPLE: 130.356, gsm8k_accuracy: 72.9234, mbxp_accuracy: 59.5584</td><td class="units">Tokens/s</td> <td class="perf">60955.10</td><td class="na" colspan="2"> N/A </td><td class="units">Tokens/s</td> <td class="perf">62108.40</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">14205.60</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">14996.60</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">34450.70</td></table></div></div>
</div>
</div>
</main>
