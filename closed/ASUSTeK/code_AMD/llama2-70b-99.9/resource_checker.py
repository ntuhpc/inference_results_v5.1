...
data = {
    ...
    "llama3_1-405b": {
        "model_path" : ["/model/llama3.1-405b/fp4_quantized", "/model/llama3.1-405b/fp8_quantized"],
        "safetensor_md5sum" : ["7dccd6047bbf888c31bce62f588b9dbb", "9cf165d1e925964ff9936902d6db3613"],
