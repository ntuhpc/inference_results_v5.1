See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Lenovo/results/SE100_RTX2000E_Ada_16GBx1_TRT/summary.html)
<header class="topbar">
...
<h2>Lenovo - ThinkEdge SE100 (1x RTX-2000E-Ada-16GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Lenovo/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Lenovo/results/SE100_RTX2000E_Ada_16GBx1_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Lenovo/measurements/SE100_RTX2000E_Ada_16GBx1_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Lenovo/compliance/SE100_RTX2000E_Ada_16GBx1_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<table class="table">
<tr><td>accelerator_model_name</td><td>NVIDIA RTX-2000E-Ada-16GB</td></tr><tr><td>accelerators_per_node</td><td>1</td></tr><tr><td>accelerator_memory_capacity</td><td>16 GB</td></tr><tr><td>accelerator_host_interconnect</td><td>PCIe Gen4 x8</td></tr><tr><td>accelerator_frequency</td><td></td></tr><tr><td>accelerator_interconnect</td><td>N/A</td></tr><tr><td>accelerator_interconnect_topology</td><td></td></tr><tr><td>accelerator_memory_configuration</td><td>GDDR6 with ECC</td></tr><tr><td>accelerator_on-chip_memories</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Core(TM) Ultra 7 255H</td></tr><tr><td>host_processors_per_node</td><td>1</td></tr><tr><td>host_processor_core_count</td><td>16</td></tr><tr><td>host_processor_frequency</td><td>2.0GHz Turbo: 5.1GHz</td></tr><tr><td>host_memory_capacity</td><td>64 GB</td></tr><tr><td>host_memory_configuration</td><td>2x 32GB MTC16C2085S1VC64BD1-KFF</td></tr><tr><td>host_processor_caches</td><td>L1d: 416 KiB, L1i: 640 KiB, L2: 26 MiB, L3: 24 MiB</td></tr><tr><td>host_processor_interconnect</td><td></td></tr><tr><td>host_processor_vcpu_count</td><td>0</td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.8, CUDA 12.9</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04 LTS</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.8, CUDA 12.9, Driver 575.57</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">3d-unet-99</td><td class="acc-target">DICE: 0.8531</td><td class="units">Samples/s</td> <td class="perf">0.61</td><td class="units">Latency (ms)</td> <td class="perf">3683.79</td><td class="na" colspan="2"> N/A </td><tr><td class="model">3d-unet-99.9</td><td class="acc-target">DICE: 0.8608</td><td class="units">Samples/s</td> <td class="perf">0.61</td><td class="units">Latency (ms)</td> <td class="perf">3683.79</td><td class="na" colspan="2"> N/A </td><tr><td class="model">resnet50</td><td class="acc-target">acc: 75.6954</td><td class="units">Samples/s</td> <td class="perf">6607.08</td><td class="units">Latency (ms)</td> <td class="perf">0.51</td><td class="units">Latency (ms)</td> <td class="perf">1.48</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Samples/s</td> <td class="perf">119.47</td><td class="units">Latency (ms)</td> <td class="perf">8.50</td><td class="units">Latency (ms)</td> <td class="perf">70.20</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Samples/s</td> <td class="perf">0.13</td><td class="units">Latency (ms)</td> <td class="perf">7479.35</td><td class="na" colspan="2"> N/A </td></table></div></div>
</div>
</div>
</main>
