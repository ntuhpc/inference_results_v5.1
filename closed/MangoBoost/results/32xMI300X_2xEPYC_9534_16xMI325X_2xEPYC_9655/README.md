See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/MangoBoost/results/32xMI300X_2xEPYC_9534_16xMI325X_2xEPYC_9655/summary.html)
<header class="topbar">
...
<h2>MangoBoost - MangoBoost Heterogeneous Cluster (4x8x MI300X-192GB, 2x8x MI325X-256GB, LLMBoost)</h2>
</div>
...
<span id="tester_val" class="details-cell">MangoBoost</span>
</div>
<div class="details-group">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/MangoBoost/results/32xMI300X_2xEPYC_9534_16xMI325X_2xEPYC_9655" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/MangoBoost/measurements/32xMI300X_2xEPYC_9534_16xMI325X_2xEPYC_9655" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/MangoBoost/compliance/32xMI300X_2xEPYC_9534_16xMI325X_2xEPYC_9655" class="button">Compliance</a>
</div>
</div>
</div>
...
<table class="table">
<tr><td>accelerator_model_name</td><td>AMD Instinct MI300X 192GB HBM3 (x32), AMD Instinct MI325X 256GB HBM3e (x16)</td></tr><tr><td>accelerators_per_node</td><td>8</td></tr><tr><td>accelerator_memory_capacity</td><td>192 GB (MI300X), 256 GB (MI325X)</td></tr><tr><td>accelerator_host_interconnect</td><td>N/A</td></tr><tr><td>accelerator_frequency</td><td></td></tr><tr><td>accelerator_interconnect</td><td>XGMI</td></tr><tr><td>accelerator_interconnect_topology</td><td></td></tr><tr><td>accelerator_memory_configuration</td><td>HBM3 (MI300X), HBM3E (MI325X)</td></tr><tr><td>accelerator_on-chip_memories</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>AMD EPYC 9534 (on MI300X node), AMD EPYC 9655 (on MI325X node)</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>64(AMD EPYC 9534) and 96(AMD EPYC 9655)</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>2.2TiB</td></tr><tr><td>host_memory_configuration</td><td>24x 96GB Samsung M321RYGA0BB0-CQKZJ</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>Mango LLMBoost AI Enterprise Platform, vllm-0.9.0.2.dev108+g71faa1880.d20250717.rocm641, ROCm 6.12.12</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 22.04.5 LTS (jammy)</td></tr><tr><td>other_software_stack</td><td>Pytorch 2.7.0+gitf717b2a, hipblaslt-0.15.0-aa0bda7b, flash-attn 2.7.4.post1</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">153076.00</td><td class="units">Tokens/s</td> <td class="perf">169197.00</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">153076.00</td><td class="units">Tokens/s</td> <td class="perf">169197.00</td></table></div></div>
</div>
</div>
</main>
