...
base = {
    ...
    loadgen_fields.min_duration: 7200000,
    #loadgen_fields.max_duration: 600000,
    ...
    llm_fields.trtllm_runtime_flags: {
        ...
        'max_num_tokens': 1536,
        #'batch_scheduler_policy': 'guaranteed_no_evict', #'max_util',
        'batch_scheduler_policy': 'max_util',#'guaranteed_no_evict',
        'context_chunking_policy': 'first_come_first_served',
        'kvcache_free_gpu_mem_frac': 0.9,  # Progressively lower by 0.1/0.05 if you hit OOM errors.
        'enable_chunked_context': True,
        #'enable_chunked_context': False,
        #'total-sample-count': 13368,
        #'total-sample-count': 66840,
    },
    ...
    loadgen_fields.offline_expected_qps:  475.0,
