See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/open/Krai/results/xe9680_h100_x8_vllm_092/summary.html)
<header class="topbar">
...
<h2>Krai - Dell PowerEdge XE9680 (8x H100-SXM-80GB, vLLM v0.9.2)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/Krai/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/Krai/results/xe9680_h100_x8_vllm_092" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/Krai/measurements/xe9680_h100_x8_vllm_092" class="button">Measurements</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Xeon(R) Platinum 8468</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>48</td></tr><tr><td>host_processor_frequency</td><td>2.1 GHz (base); 3.8 GHz (max turbo)</td></tr><tr><td>host_memory_capacity</td><td>2 TiB</td></tr><tr><td>host_memory_configuration</td><td>32x 64GB Dual Rank DDR5-4800 Registered Standard Memory</td></tr><tr><td>host_processor_caches</td><td>L1d: 4.5 MiB (96 instances); L1i: 3 MiB (96 instances); L2: 192 MiB (96 instances); L3: 210 MiB (2 instances)</td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>vLLM v0.9.2</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04.2 LTS (6.8.0-71-generic #71-Ubuntu SMP PREEMPT_DYNAMIC Tue Jul 22 16:52:38 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux)</td></tr><tr><td>other_software_stack</td><td>vllm/vllm-openai:v0.9.2, CUDA 12.9, Driver 575.57.08</td></tr><tr><td>sw_notes</td><td>Powered by the KRAI X automation technology</td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama3_1-70b-fp8_dyn</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="accuracy">ROUGE1: 47.5635, ROUGE2: 25.2651, ROUGEL: 31.5085, TOKENS PER SAMPLE: 293.7</td><td class="units">Tokens/s</td> <td class="perf">21433.30</td><td class="accuracy">ROUGE1: 47.5639, ROUGE2: 25.2656, ROUGEL: 31.5083, TOKENS PER SAMPLE: 293.8</td><td class="units">Tokens/s</td> <td class="perf">10180.10</td><td class="accuracy">ROUGE1: 47.5635, ROUGE2: 25.2651, ROUGEL: 31.5082, TOKENS PER SAMPLE: 293.7</td><td class="units">Tokens/s</td> <td class="perf">22819.60</td></table></div></div>
</div>
</div>
</main>
