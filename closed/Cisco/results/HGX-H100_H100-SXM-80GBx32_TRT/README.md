See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Cisco/results/HGX-H100_H100-SXM-80GBx32_TRT/summary.html)
<header class="topbar">
...
<h2>Cisco - HPF HGX System (32xH100-SXM-80GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Cisco/results/HGX-H100_H100-SXM-80GBx32_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Cisco/measurements/HGX-H100_H100-SXM-80GBx32_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Cisco/compliance/HGX-H100_H100-SXM-80GBx32_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_network_card_count</td><td>1x Intel X710-T2L 10GbE</td></tr><tr><td>host_networking</td><td>Storage: 2x BF3 ConnectX-7 400Gb/s, Compute: 8x BF3 ConnectX-7 400Gb/s, Management: 100Gb/s Ethernet NIC</td></tr><tr><td>host_networking_topology</td><td>Ethernet Fabric</td></tr><tr><td>network_speed_mbit</td><td></td></tr><tr><td>nics_enabled_connected</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>nics_enabled_os</td><td></td></tr><tr><td>number_of_type_nics_installed</td><td></td></tr></table></div></div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.8, CUDA 12.8</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 22.04</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.8, CUDA 12.8, cuDNN 8.9.7, Driver 570.86.10</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">122274.00</td><td class="units">Tokens/s</td> <td class="perf">124879.00</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">122274.00</td><td class="units">Tokens/s</td> <td class="perf">124879.00</td><tr><td class="model">llama3_1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">1126.94</td><td class="units">Tokens/s</td> <td class="perf">1561.57</td></table></div></div>
</div>
</div>
</main>
