See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/open/AMD/results/8xMI355X_2xEPYC_9575F/summary.html)
<header class="topbar">
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/AMD/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/AMD/results/8xMI355X_2xEPYC_9575F" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/open/AMD/measurements/8xMI355X_2xEPYC_9575F" class="button">Measurements</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>AMD EPYC 9575F</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>64</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>12TiB</td></tr><tr><td>host_memory_configuration</td><td>24x 128GiB Micron Technology MTC40F2047S1RC64BB1 UXCC</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>host_network_card_count</td><td>4x 10Gbit</td></tr><tr><td>host_networking</td><td>2x Intel Corporation Ethernet Controller X710 for 10GBASE-T, 2x Intel Corporation Ethernet Controller 10G X550T</td></tr><tr><td>host_networking_topology</td><td>N/A</td></tr><tr><td>network_speed_mbit</td><td></td></tr><tr><td>nics_enabled_connected</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>nics_enabled_os</td><td></td></tr><tr><td>number_of_type_nics_installed</td><td></td></tr></table></div></div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>vLLM 0.9.1.dev2+g790cf6584.d20250519.rocm650, Pytorch 2.8.0a0+git37f92bb, ROCm 6.5.0.60500-crnm350d.40~22.04</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 22.04.5 LTS</td></tr><tr><td>other_software_stack</td><td>hipblast 0.15.0.60500-crnm350d.40~22.04, Aiter 0.1.2.dev46+g13675a7.d20250514</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="accuracy">ROUGE1: 44.5302, ROUGE2: 22.1844, ROUGEL: 29.0004, TOKENS PER SAMPLE: 285.7</td><td class="units">Tokens/s</td> <td class="perf">93045.80</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="accuracy">ROUGE1: 44.5302, ROUGE2: 22.1844, ROUGEL: 29.0004, TOKENS PER SAMPLE: 285.7</td><td class="units">Tokens/s</td> <td class="perf">93045.80</td><tr><td class="model">llama3_1-405b_finetuned</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="accuracy">ROUGEL: 21.17008, exact match: 87.22472, TOKENS PER SAMPLE: 602.5</td><td class="units">Tokens/s</td> <td class="perf">2019.04</td><tr><td class="model">llama3_1-405b_pruned</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="accuracy">ROUGEL: 21.61866, exact match: 86.59525, TOKENS PER SAMPLE: 760.8</td><td class="units">Tokens/s</td> <td class="perf">1942.15</td></table></div></div>
</div>
</div>
</main>
