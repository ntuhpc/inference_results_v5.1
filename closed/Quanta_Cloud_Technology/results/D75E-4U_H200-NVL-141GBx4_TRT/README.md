See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v5.1/blob/refs/heads/main/closed/Quanta_Cloud_Technology/results/D75E-4U_H200-NVL-141GBx4_TRT/summary.html)
<header class="topbar">
...
<h2>Quanta_Cloud_Technology - D75E-4U_H200-NVL-141GBx4</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/code" class="button">Code</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/results/D75E-4U_H200-NVL-141GBx4_TRT" class="button">Result Logs</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/measurements/D75E-4U_H200-NVL-141GBx4_TRT" class="button">Measurements</a>
<a href="https://github.com/mlcommons/submissions_inference_v5.1/tree/main/closed/Quanta_Cloud_Technology/compliance/D75E-4U_H200-NVL-141GBx4_TRT" class="button">Compliance</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>Intel(R) Xeon(R) Platinum 6787P</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>86</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>1 TB</td></tr><tr><td>host_memory_configuration</td><td>16x DDR5-6400 64GB</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.8, CUDA 12.8</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Rocky Linux 9.4</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.8, CUDA 12.8, cuDNN 8.9.7, Driver 570.148.08</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">dlrm-v2-99</td><td class="acc-target">AUC: 79.5069</td><td class="units">Queries/s</td> <td class="perf">202030.00</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">263090.00</td><tr><td class="model">dlrm-v2-99.9</td><td class="acc-target">AUC: 80.2297</td><td class="units">Queries/s</td> <td class="perf">154025.00</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">159060.00</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">13736.10</td><td class="units">Tokens/s</td> <td class="perf">6709.74</td><td class="units">Tokens/s</td> <td class="perf">15057.60</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">13730.70</td><td class="units">Tokens/s</td> <td class="perf">6712.97</td><td class="units">Tokens/s</td> <td class="perf">15167.10</td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">25753.80</td><td class="units">Queries/s</td> <td class="perf">21944.10</td><td class="units">Tokens/s</td> <td class="perf">25180.80</td><tr><td class="model">retinanet</td><td class="acc-target">mAP: 37.1745</td><td class="units">Queries/s</td> <td class="perf">6600.50</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">6618.99</td><tr><td class="model">stable-diffusion-xl</td><td class="acc-target">CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td class="units">Queries/s</td> <td class="perf">7.83</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">8.36</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">15061.70</td></table></div></div>
</div>
</div>
</main>
