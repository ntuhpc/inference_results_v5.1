...
MODEL_SELECT() {
    ...
    case $MODEL_NAME in
	llama3.1-405b-mxfp4)
            MODEL_PATH="/model/Llama-3.1-405B-Instruct-mxfp4/"
            MODEL_TEMPLATE_TYPE="/model/Llama-3.1-405B-Instruct-mxfp4/"
            TOKENIZER_PATH="/model/Llama-3.1-405B-Instruct/"
	    TOKENIZER_TYPE="hf"
            MODEL_TEMPLATE_TYPE="base"
            MODEL_FRAMEWORK="llama"
            ;;
        llama2-7b-chat)
