...
data = {
    "llama2-70b": {
        ...
        "safetensor_md5sum" : ["4d0cbae6b8bccbdfc8fdd73aa2829917", "332a949d2829dd1b96fb2c162075c993"],
    ...
    "llama3_1-405b": {
        ...
        "safetensor_md5sum" : ["7dccd6047bbf888c31bce62f588b9dbb"],
    ...
    "mixtral-8x7b": {
        "offline" : {
            "model_path" : "/model/mixtral-8x7b/offline/fp8_quantized",
            "safetensor_md5sum" : ["d429c34b5ea2876a0b788ddee0165d7e"],
            "dataset_path" : "/data/mixtral-8x7b/mlperf_mixtral8x7b_dataset_15k.pkl",
            "dataset_md5sum" : "ded6c711288c9bbca02929855557b8c1",
        },
        "server" : {
            "model_path" : "/model/mixtral-8x7b/server/fp8_quantized",
            "safetensor_md5sum" : ["8c3975bb37411fa33d406dbaa515ae3c"],
            "dataset_path" : "/data/mixtral-8x7b/mlperf_mixtral8x7b_dataset_15k.pkl",
            "dataset_md5sum" : "ded6c711288c9bbca02929855557b8c1",
        },
    },
